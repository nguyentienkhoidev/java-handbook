...
System.out.println(isLonger.test("Fox Dev")); // false
```
...
System.out.println(stringToLength.apply("Fox Dev")); // 8
```
...
printString.accept("Fox Dev"); // In ra "Fox Dev"
```
...
```java
Supplier<String> supplier = () -> "Fox Dev";
System.out.println(supplier.get()); // Fox Dev
```
...
public interface SampleFunctionalInterface {
    ...
    default void welcome() {
        System.out.println("Welcome to Fox Dev");
    }
}
```
...
public class App {
    public static void main(String[] args) {
        ...
        sample.welcome();      // Output: Welcome to Fox Dev
