...
![](../images/20250908_151526_pasted-1757319326111.png)
...
![](../images/20250908_151526_pasted-1757319326112.png)
...
```java
String s1 = new String("Welcome to Fox Dev");
```

Trong trường hợp như vậy, JVM sẽ tạo một đối tượng String mới trong bộ nhớ heap bình thường (không phải pool) và giá trị `“Welcome to Fox Dev”` theo nghĩa đen sẽ được đặt trong **Spring constant pool**. Biến s sẽ tham chiếu đến đối tượng trong heap (không phải pool).
