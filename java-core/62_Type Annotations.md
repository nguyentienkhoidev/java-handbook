...
| ElementType | Ý nghĩa |
| --- | --- |
| `TYPE_PARAMETER` | Annotation đặt trên **khai báo type parameter** (ví dụ `<@NonNull T>`). |
| `TYPE_USE` | Annotation đặt trên **mọi nơi type được sử dụng** (ví dụ `List<@NonNull String>`, cast, new, throws, …). |
